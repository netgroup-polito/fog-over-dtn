...
mqttBrokerHost = 'RABBITMQ_HOST'
mqttBrokerPort = 1883
mqttUser = 'RABBITMQ_USER'
mqttPassword = 'RABBITMQ_PASSWORD'

# Address and port of the DTN daemon
DAEMON_ADDRESS = 'DTN_DAEMON_ADDRESS'
DAEMON_PORT = DTN_DAEMON_PORT
...
SOURCE_DEMUX_TOKEN = 'DTN_SRC_DEMUX_TOKEN'
...
while True:
    ...
    mqttClient.publish(mqttTopic, mqttDataJson, 1)
